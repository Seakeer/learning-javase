package me.seakeer.learning.javase.nio.simpleiomodel.asyncnoblocking;
...
/**
 * AsyncNonBlockingClient;
 *
 * @author Seakeer;
 * @date 2024/10/12;
 */
public class AsyncNonBlockingClient {
    ...
    public static void main(String[] args) {
        AsyncNonBlockingClient client = new AsyncNonBlockingClient("127.0.0.1", 9090);
        mockSendMsg2Server(client);
        client.start();
    }

    private static void mockSendMsg2Server(AsyncNonBlockingClient client) {
    ...
    public AsyncNonBlockingClient(String serverHostname, int serverPort) {
        this.serverHostname = serverHostname;
        this.serverPort = serverPort;
    }

    public AsyncNonBlockingClient connect() {
        try {
