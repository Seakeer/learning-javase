...
public class SyncBlockingServer {
    ...
    public SyncBlockingServer(int port) {
        this.port = port;
    }

    public static void main(String[] args) {
        SyncBlockingServer server = new SyncBlockingServer(9999);
        mockSendMsg2Client(server);
        server.start();
    }

    private static void mockSendMsg2Client(SyncBlockingServer server) {
