...
/**
 * SyncNonBlockingClient;
 *
 * @author Seakeer;
 * @date 2024/10/12;
 */
public class SyncNonBlockingClient {
    ...
    public SyncNonBlockingClient(String serverHostname, int serverPort) {
        this.serverHostname = serverHostname;
        this.serverPort = serverPort;
    }

    public static void main(String[] args) {
        SyncNonBlockingClient client = new SyncNonBlockingClient("127.0.0.1", 9090);
        mockSendMsg2Server(client);
        client.start();
    }

    private static void mockSendMsg2Server(SyncNonBlockingClient client) {
    ...
    public SyncNonBlockingClient connect() {
        try {
