...
public class AsyncNonBlockingServer {
    ...
    public AsyncNonBlockingServer(int port) {
        this.port = port;
    }

    public static void main(String[] args) {
        AsyncNonBlockingServer server = new AsyncNonBlockingServer(9090);
    ...
    private static void mockSendMsg2Client(AsyncNonBlockingServer server) {
        new Thread(() -> {
